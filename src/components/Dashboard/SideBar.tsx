...
export default function SideBar({ set_view, data }: Props) {
    ...
    return (
        <div className={` items-center justify-center border-r p-1`}>
            <div className={`flex flex-col h-svh transition-all ${isVisible ? 'h-full w-80 md:w-[400px]' : 'h-0 w-0'}`}>
                ...
                <Separator className="my-3" />
                <div className="flex flex-row justify-between -m-1 pl-7 pr-10 pb-7">
            ...
            <div className="w-[100]px h-[100]px border-0">
