            ...
            <div className="w-full h-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700 justify-self-end">
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form action="#" className="space-y-4 md:space-y-6">
                        <div>
                            <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name of server</label>
                            <input 
                                id="name"
                                type="text"
                        ...
                        <div>
                            <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select Version</label>
                            <input 
                                id="version"
                                list='versions'
                                placeholder=""
